...
| `tags` | YAML list, 3-5 specific Chinese keywords | `[keyword1, keyword2, keyword3, review]` |
...
| Good | Bad |
|------|-----|
| `Author2004_topic_material_condition.md` | `authorcorrosionofmaterial2004.md` |
| `Author2018_topic_method.md` | `authortopicmethodology2018.md` |
| `Author2011_material_failure_analysis.md` | `authorstainlesssteelcorrosion2011.md` |
